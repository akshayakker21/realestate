...
function Page1() {
  ...
  return (
    <div>
      <img src='https://img.staticmb.com/mbphoto/property/cropped_images/2023/Apr/10/Photo_h600_w900/66439247_10_hatsAppImage20230410at11.53.34_600_900.jpeg' alt=''/>
      <Card
  style={{
    width:800
  }}
>
  <CardHeader>
    Owner Name :  Vikram Tripuraneni
  </CardHeader>
  <ListGroup flush>
    <ListGroupItem>
    Price Breakup : 
₹1.01 Cr₹92 Lac | ₹6,06,000 Approx. Registration Charges
    </ListGroupItem>
    <ListGroupItem>
    Booking Amount : 
₹5.0 Lac
    ...
    <ListGroupItem>
    Address : 
Bachupally, Hyderabad - North, Andhra Pradesh
    </ListGroupItem>
    <ListGroupItem>
     Ownership : 
Freehold
